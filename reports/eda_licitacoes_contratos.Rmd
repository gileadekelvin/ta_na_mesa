...
source(here("code/processa_licitacoes.R"))
source(here("code/processa_licitantes.R"))
source(here("code/processa_pessoas.R"))
```

```{r}
anos <- c(2017, 2018, 2019)

licitacoes_merenda <- processa_licitacoes(anos) %>% 
